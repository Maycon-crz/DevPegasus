...
<html lang="pt-br">
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="<?= url('theme/assets/css/portfolio_css/portfolio_floriculture_style.css?ver=1.0'); ?>">        
    </head>
    <body>
        ...
        <main class="container-fluid p-0">
            <section class="image-container">
                ...
                <header class="top-info-container">
                    <h1 class="overlay-text">Modelo de Site <br> Floricultura</h1>
                    <div class="u-social">
                        <a class="me-3" target="_blank" href="#" title="Link do Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icons" viewBox="0 0 320 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#f4f5f6}</style><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/></svg>
                        </a>
                        <a class="me-3" target="_blank" href="#" title="Link do Twitter">
                        ...
                        <a class="me-3" target="_blank" href="#" title="Link do Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" class="svg-icons" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#fcfcfc}</style><path d="M224.1 141c-63.6 0-114.9 51.3-114.9 114.9s51.3 114.9 114.9 114.9S339 319.5 339 255.9 287.7 141 224.1 141zm0 189.6c-41.1 0-74.7-33.5-74.7-74.7s33.5-74.7 74.7-74.7 74.7 33.5 74.7 74.7-33.6 74.7-74.7 74.7zm146.4-194.3c0 14.9-12 26.8-26.8 26.8-14.9 0-26.8-12-26.8-26.8s12-26.8 26.8-26.8 26.8 12 26.8 26.8zm76.1 27.2c-1.7-35.9-9.9-67.7-36.2-93.9-26.2-26.2-58-34.4-93.9-36.2-37-2.1-147.9-2.1-184.9 0-35.8 1.7-67.6 9.9-93.9 36.1s-34.4 58-36.2 93.9c-2.1 37-2.1 147.9 0 184.9 1.7 35.9 9.9 67.7 36.2 93.9s58 34.4 93.9 36.2c37 2.1 147.9 2.1 184.9 0 35.9-1.7 67.7-9.9 93.9-36.2 26.2-26.2 34.4-58 36.2-93.9 2.1-37 2.1-147.8 0-184.8zM398.8 388c-7.8 19.6-22.9 34.7-42.6 42.6-29.5 11.7-99.5 9-132.1 9s-102.7 2.6-132.1-9c-19.6-7.8-34.7-22.9-42.6-42.6-11.7-29.5-9-99.5-9-132.1s-2.6-102.7 9-132.1c7.8-19.6 22.9-34.7 42.6-42.6 29.5-11.7 99.5-9 132.1-9s102.7-2.6 132.1 9c19.6 7.8 34.7 22.9 42.6 42.6 11.7 29.5 9 99.5 9 132.1s2.7 102.7-9 132.1z"/></svg>
                        </a>
                        <a class="" target="_blank" href="#" title="Link do Pinterest">
            ...
            <section class="row m-1 m-md-5">
                <div class="col-12 col-md-4">
                    <h3 class="text-center mt-3">Sobre nós</h3>
                    <p class="mt-3">Descubra a beleza atemporal das flores na nossa floricultura. Com uma seleção encantadora de arranjos, buquês e plantas, estamos prontos para adicionar um toque de cor e fragrância à sua vida.</p>
                    <a href="#" title="" class="form-control btn btn-outline-info mt-5">Consulte Mais informações</a>
                </div>
                <div class="col-12 col-md-4">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/buque-de-primavera.jpg'); ?>" alt="" class="form-control bg-transparent card-img-square border-0 p-0">
                </div>
                <div class="col-12 col-md-4">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/floricultura-organizando-flores-na-loja.jpg'); ?>" alt="" class="form-control bg-transparent card-img-square border-0 p-0">
                </div>
            </section>
            <section class="row m-1 m-md-5">
                <div class="personalized-column">
                    ...
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/path-way.jpg'); ?>" alt="" class="form-control bg-transparent card-img-rectangular border-0 p-0">
                </div>
                <div class="personalized-column">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/male-florist-arranging-fresh-roses-florist-shop.jpg'); ?>" alt="" class="form-control bg-transparent card-img-square border-0 p-0">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/flowers-floral-shop-different-types.jpg'); ?>" alt="" class="form-control bg-transparent card-img-square border-0 p-0">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/carrinho-de-floricultura-com-muitas-variedades-de-flores.jpg'); ?>" alt="" class="form-control bg-transparent card-img-square border-0 p-0">
                </div>
                <div class="personalized-column">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/top-view-bouquet-flowers-with-blank-card.jpg'); ?>" alt="" class="form-control bg-transparent card-img-rectangular border-0 p-0">
                    <img src="<?= url('theme/assets/img/servico_de_desenvolvimento/portfolio_img/floriculture/closeup-colorful-flower-bouquets-containers-outdoor-shop.jpg'); ?>" alt="" class="form-control bg-transparent card-img-rectangular border-0 p-0">
                </div>                
            </section>
            <section class="row m-1 m-md-5">
                <div class="col-12 col-md-8">
                    <h2>Explore as Maravilhas Naturais</h2>
                    <p>Se você é apaixonado por aventura e natureza, está no lugar certo. Do alto das montanhas majestosas até as trilhas serenas nas florestas, nossa região oferece uma variedade deslumbrante de cenários naturais para os amantes da exploração. Com rotas como Trilha do Cânion, Pico do Aventureiro e Caminho das Cachoeiras, você encontrará a sua próxima grande aventura ao ar livre.</p>
                </div>
